...
module.exports = {
  ...
  process: function(docs) {
    ...
    // If the title contains a name starting with sofa., e.g. "sofa.CheckoutService", then add the module name
    // without the sofa. to the title text, e.g. "checkoutservice".
    function extractTitleWords(title) {
      var match = /sofa.([A-Z]\w*)/.exec(title);
      if ( match ) {
